...
const paths = [
  "M0,0 m-50,0 a50,50 0 1,0 100,0 a50,50 0 1,0 -100,0",
...
export default function TooltipWithMorph({ children, tooltipImage }) {
  ...
  useEffect(() => {
    ...
    const loop = () => {
      ...
      const morph = flubber.interpolate(paths[morphIndex.current], paths[nextIndex]);
